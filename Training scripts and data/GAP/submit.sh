...
config_type_n_sparse={slice_sample_high:400:phonons_54_high:400:phonons_128_high:400:prim_random:300:default:2500} \
sparse_method=cur_points \
:soap_turbo l_max=6 alpha_max={{13}} \
atom_sigma_r={{0.5}} atom_sigma_t={{0.5}} \
atom_sigma_r_scaling={{ 0.0}} atom_sigma_t_scaling={{0.0}} \
zeta=4 rcut_hard=6.5 rcut_soft=5.0 \
delta=1.0 basis="poly3" \
scaling_mode="polynomial"  amplitude_scaling={{1.0}}  \
...
/home/zhanglei1/software/QUIP_OPENMPI/build/linux_x86_64_gfortran_openmp/quip E=T F=T atoms_filename=testing.xyz param_filename=gap_Fe_test.xml  | grep AT | sed 's/AT//' > quip_validate.xyz
